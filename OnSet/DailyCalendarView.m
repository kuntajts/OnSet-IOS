...
-(void)markSelected:(BOOL)blnSelected
{
    ...
    if([self.date isDateToday]){
        self.dateLabelContainer.backgroundColor = (blnSelected)?[UIColor whiteColor]: [UIColor colorWithHex:0xffffff];
        
        self.dateLabel.textColor = (blnSelected)?[UIColor colorWithHex:0xffffff]:[UIColor whiteColor];
    }else{
